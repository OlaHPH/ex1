...
### x) Read and summarize (This subtask x does not require tests with a computer. Some bullets per article is enough for your summary, feel free to write more if you like)
        1. OWASP: OWASP 10 2021
                - A05:2021-Security Misconfiguration
                        - Overview - upranked from #6 to #5, part of the reason is the shift toward highly configurable softwares.90% of tested application has some form of misconfiguration, over  200k occurrences of CWE (Common Weakness Enumeration) in this risk category. Including CWE16 (Config.) and CWE611 (Improper Restriction of XML Extension Entity Reference)
                        ...
                        - Preventive method - implement secure installation process, including
                                - **automanted, repeatable** hardening process making it **fast and easey** to deploy another environment that is **properly** locked down. Different environments (Dev, QA, prod.) should be configured **identically** with **different credetials** used for each. 
