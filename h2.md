...
### b) Injected. Solve WebGoat: - TBC 
        ...
        p5. GRANT ALTER TABLE TO (all schemas as the task asked for "tables")  vs GRANT ALTER ON TABLE TO (one specific schema) - https://dba.stackexchange.com/questions/317844/grant-alter-to-role-vs-grant-alter-on-schema
        
        p9. the command shown here was quite confusing so at first it took me few times to get through ('so what's actually the right command line is until I saw the line under - it was "normally" correct")  
         ![image](https://user-images.githubusercontent.com/99587532/215704214-d8cde9d8-05a4-41e7-ac43-3aa19b5c5e1a.png)
        p11 and the TAN - this sone took me quite a while to figure out the solution. While searching out, I found 2 approaches: 
