...
* Description - list of application features potentially increasing the application's vulnerability 
                a.  missing proper security hardening accross any part of the app stack of improperly configured permissions on cloud services,
                b. unnecessary featured enabled or installed (ports, pages, accounts, priviliges, etc.),
