        ...
        1. OWASP: OWASP 10 2021
                - A05:2021-Security Misconfiguration
                        ...
                        - Preventive method - implement secure installation process, including
                                - __automated, repeatable__ hardening process making it **fast and easey** to deploy another environment that is **properly** locked down. Different environments (Dev, QA, prod.) should be configured **identically** with **different credetials** used for each. 
